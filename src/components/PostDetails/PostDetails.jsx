...
export default function PostDetails() {
  ...
  return (
   <div className='container'>
         <div className="card" id='postdetails-card' >
            <div className="body">
                <h4 id='postdetails-title'><strong>{state.title}</strong></h4>
              <p className="">
                {state.body}
              </p>
              <p className="username" style={{marginTop:"30px"}}>from: @Yaya12085</p>
              <div className="footer">
                ...
                <button type="button" className="btn btn-danger"><i className="fa-solid fa-trash me-2"></i>Delete</button>
                <buttons className="btn btn-light" type="button"><i className="fa-solid fa-file-pen me-2"></i>Edit</buttons>
